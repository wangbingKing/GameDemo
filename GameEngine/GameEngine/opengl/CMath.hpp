...
public:
    ...
    //math
    static inline void esScale ( ESMatrix *result, GLfloat sx, GLfloat sy, GLfloat sz )
    {
        result->m[0][0] *= sx;
        result->m[0][1] *= sx;
        result->m[0][2] *= sx;
    ...
    static inline void esTranslate ( ESMatrix *result, GLfloat tx, GLfloat ty, GLfloat tz )
    {
    ...
    static inline void esRotate ( ESMatrix *result, GLfloat angle, GLfloat x, GLfloat y, GLfloat z )
    {
    ...
    static inline void esFrustum ( ESMatrix *result, float left, float right, float bottom, float top, float nearZ, float farZ )
    {
    ...
    static inline void esPerspective ( ESMatrix *result, float fovy, float aspect, float nearZ, float farZ )
    {
    ...
    static inline void esOrtho ( ESMatrix *result, float left, float right, float bottom, float top, float nearZ, float farZ )
    {
        float       deltaX = right - left;
        float       deltaY = top - bottom;
        float       deltaZ = farZ - nearZ;
    ...
    static inline void esMatrixMultiply ( ESMatrix *result, ESMatrix *srcA, ESMatrix *srcB )
    {
        ESMatrix    tmp;
        int         i;
    ...
    static inline void esMatrixLoadIdentity ( ESMatrix *result )
    {
    ...
    static inline void esMatrixLookAt ( ESMatrix *result,
